...
const blocks={};
let snake=[{x:1,y:3}];/*we will store snake in array of object format.initially size of snake will be 3(1st object is the head of the snake)*/ 
let direction='down';
...
startButton.addEventListener("click",()=>{
    ...
    timeIntervalId=setInterval(()=>{
        let [min,sec]=time.split("-").map(Number);//destructuring-storing the values of an array in the variables(min,sec) (we are dividing 00-00 on the basis of - so it will given an array ["00","00"])
